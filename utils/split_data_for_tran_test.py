# help run
# python splitdata.py ten_thu_muc_anh
...
def split_dataset_into_3(path_to_dataset, train_ratio, valid_ratio):
    ...
    dir_train = os.path.join(os.path.dirname(path_to_dataset), '{}_train'.format(img_dir))
    dir_valid = os.path.join(os.path.dirname(path_to_dataset), '{}_validation'.format(img_dir))
    dir_test = os.path.join(os.path.dirname(path_to_dataset), '{}_test'.format(img_dir))
...
split_dataset_into_3(img_dir, 0.6, 0.01)
